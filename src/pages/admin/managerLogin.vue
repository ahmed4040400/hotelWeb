                ...
                <form @submit.prevent="handleLogin">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="email" v-model="email" name="email" placeholder="admin@example.com" type="email" required
    ...
    try {
        ...
        if (result.success) {
            if (authStore.isManager) {
                ...
                errorMessage.value = 'يجب أن تكون مدير نظام للوصول إلى لوحة التحكم.';
                authStore.logout();
            }
        } else {
